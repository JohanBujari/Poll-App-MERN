        ...
        >
          <div class="col-md-4">
            ...
            <p style={{ color: "red", textAlign: "left" }}>
              {error && error.messageUsername
                ? error.messageUsername
                : error && error.messageUnique
                ? error.messageUnique
                : null}
            </p>
          </div>
          ...
          <div class="col-md-4">
            ...
            <p style={{ color: "red", textAlign: "left" }}>
              {error && error.messageRequired
                ...
                : error && error.messagePasswordRegex
                ? error.messagePasswordRegex
                : null}
            </p>
          </div>
          ...
          <div class="col-12">
            ...
            <p style={{ marginRight: "550px", marginTop: "10px" }}>
              <Link to="/login">Alredy created? Sign in</Link>
            </p>
          </div>
        </form>
      </div>
